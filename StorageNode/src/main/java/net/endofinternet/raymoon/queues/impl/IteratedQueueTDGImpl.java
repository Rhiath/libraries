...
//    }
    ...
    private <T> IteratedQueueToken<T> getNextQueueElement(SQLiteConnection connection, String iteratorName, Class<T> type, long position) throws SQLiteException, PersistenceException {
